...
public class SecondLevelAdapter extends BaseExpandableListAdapter {
    ...
    public ListObject child;
    Context mContext;
    LayoutInflater inflater;

    public SecondLevelAdapter(ListObject child, Context context) {
        this.child = child;
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        final ListObject item = (ListObject) getChild(groupPosition, childPosition);
