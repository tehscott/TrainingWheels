...
public class RootAdapter extends BaseExpandableListAdapter {
    ...
    public class Entry {
        ...
        public Entry(CustomExpandableListView cls, SecondLevelAdapter sadpt) {
            this.cls = cls;
            this.sadpt = sadpt;
        }
    }
    ...
    public RootAdapter(Context context, ListObject root, ExpandableListView.OnGroupClickListener grpLst,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
        ...
        final ListObject item = (ListObject) getGroup(groupPosition);
